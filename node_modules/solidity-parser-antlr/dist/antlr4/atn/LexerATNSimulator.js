...
LexerATNSimulator.prototype.execATN = function (input, ds0) {
	...
	while (true) {
		...
		// A character ***REMOVED***take us back to an existing DFA state
...
LexerATNSimulator.prototype.accept = function (input, lexerActionExecutor, startIndex, index, line, charPos) {
	...
	// ***REMOVED*** to after last char in token
	input.***REMOVED***(index);
	this.line = line;
	this.column = charPos;
...
LexerATNSimulator.prototype.getEpsilonTarget = function (input, config, trans, configs, speculative, treatEofAsEpsilon) {
	...
	if (trans.serializationType === Transition.RULE) {
		...
		// like v3 and testing them on prediction, v4 ***REMOVED***test them on the
...
// traversing the DFA, we ***REMOVED***know which rule to accept.
