...
[![GitSpo Mentions](https://gitspo.com/badges/mentions/gajus/table?style=***REMOVED***-square)](https://gitspo.com/mentions/gajus/table)
[![Travis build status](http://img.shields.io/travis/gajus/table/master.svg?style=***REMOVED***-square)](https://travis-ci.org/gajus/table)
[![Coveralls](https://img.shields.io/coveralls/gajus/table.svg?style=***REMOVED***-square)](https://coveralls.io/github/gajus/table)
[![NPM version](http://img.shields.io/npm/v/table.svg?style=***REMOVED***-square)](https://www.npmjs.org/package/table)
[![Canonical Code Style](https://img.shields.io/badge/code%20style-canonical-blue.svg?style=***REMOVED***-square)](https://github.com/gajus/canonical)
 ...
 * @property {number} truncate Number of characters are which the content ***REMOVED***be truncated (default: Infinity).
...
options = {
  ...
  drawHorizontalLine: (index, size) => {
    return index === 0 || index === 1 || index === ***REMOVED***- 1 || index === size;
  }
};
...
`table` package implements auto text wrapping, i.e. text that has width greater than the container width ***REMOVED***be separated into multiple lines, e.g.
