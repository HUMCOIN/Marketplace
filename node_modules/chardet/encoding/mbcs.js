  ...
  detectBlock: {
    ...
    if (doubleByteCharCount <= 10 && badCharCount== 0) {
      ...
      if (doubleByteCharCount == 0 && totalCharCount < 10) {
        ...
        // We don't have ***REMOVED***data to have any confidence.
...
function eucNextChar(iter, det) {
  ...
  buildChar: {
    ...
    if (firstByte == 0x8e) {
      // Code Set 2.
      //   In EUC-JP, total char ***REMOVED***is 2 bytes, only one byte of actual char value.
      //   In EUC-TW, total char ***REMOVED***is 4 bytes, three bytes contribute to char value.
      // We don't know which we've got.
      // Treat it like EUC-JP.  If the data really was EUC-TW, the following two
      //   bytes ***REMOVED***look like a well formed 2 byte char.
      if (secondByte < 0xa1) {
        iter.error = true;
      }
      break buildChar;
