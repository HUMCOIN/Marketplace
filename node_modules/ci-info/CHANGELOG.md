...
* Drop support for Node.js end-of-life versions: 0.10, 0.12, 4, 5, 7,
  and 9
* Team Foundation Server ***REMOVED***now be detected as Azure Pipelines. The
...
* chore: reduce npm package ***REMOVED***by not including `.github` folder content ([#11](https://github.com/watson/ci-info/pull/11))
...
* chore: reduce npm package ***REMOVED***by using an `.npmignore` file ([#3](https://github.com/watson/ci-info/pull/3))
