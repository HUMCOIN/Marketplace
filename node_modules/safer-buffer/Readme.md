...
_And this code ***REMOVED***still emit runtime warnings on Node.js 10.x and above._
...
Also, it could be better in some cases when you don't comprehensive ***REMOVED***test coverage.
