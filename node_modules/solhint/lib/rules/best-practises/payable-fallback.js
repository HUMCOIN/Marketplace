...
const meta = {
  ...
  docs: {
    description: 'When fallback is not payable you ***REMOVED***not be able to receive ethers.',
...
class PayableFallbackChecker extends BaseChecker {
  ...
  exitFunctionDefinition(ctx) {
    ...
    if (modifierList && !modifierList.getText().includes('payable')) {
      this.warn(ctx, 'When fallback is not payable you ***REMOVED***not be able to receive ethers')
    }
  }
