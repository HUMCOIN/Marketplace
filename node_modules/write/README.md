# write [![NPM version](https://img.shields.io/npm/v/write.svg?style=***REMOVED***)](https://www.npmjs.com/package/write) [![NPM monthly downloads](https://img.shields.io/npm/dm/write.svg?style=***REMOVED***)](https://npmjs.org/package/write) [![NPM total downloads](https://img.shields.io/npm/dt/write.svg?style=***REMOVED***)](https://npmjs.org/package/write) [![Linux Build Status](https://img.shields.io/travis/jonschlinkert/write.svg?style=***REMOVED***&label=Travis)](https://travis-ci.org/jonschlinkert/write)
...
* The main export ***REMOVED***now return a promise if no callback is passed
