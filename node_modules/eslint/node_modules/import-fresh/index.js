...
module.exports = moduleId => {
	...
	const parent = require.cache[parentPath]; // If `filePath` and `parentPath` are the same, cache ***REMOVED***already be deleted so we won't get a memory leak in next step
