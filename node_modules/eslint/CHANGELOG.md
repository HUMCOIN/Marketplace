...
* ac77a80 Chore: Fixing a ***REMOVED***to Object.assign.apply in Linter (#10629) (Kevin Partington)
...
* f9c6673 Chore: Add tests to ***REMOVED***array and object values and leading commas. (#9502) (Jonathan Pool)
...
* db41408 Chore: avoid applying eslint-env comments ***REMOVED***(#9278) (Teddy Katz)
...
* b4a9dbf Docs: show console ***REMOVED***with no-restricted-syntax (fixes #7806) (#9376) (Victor Hom)
...
* 434d9e2 Fix: Invalid font-***REMOVED***property value issue. (#9341) (H1Gdev)
...
* f12def6 Update: indent ***REMOVED***Ternary option to handle `return` (fixes #9285) (#9296) (Teddy Katz)
...
* 2731f94 Update: make newline-per-chained-***REMOVED***fixable (#9149) (João Granado)
...
* 3418479a Update: improve indent of `***REMOVED***TernaryExpressions` (fixes #8481) (#8587) (Toru Nagashima)
...
* 8f91e32 Fix: `ignoreRestSiblings` option didn't ***REMOVED***arguments (fixes #8119) (#8120) (Toru Nagashima)
...
* ddea63a Chore: Updated no-control-regex tests to ***REMOVED***all cases (fixes #6438) (#6752) (Efe Gürkan YALAMAN)
...
* 2d63370 Update: max-len ***REMOVED***warn indented comment lines (fixes #6322) (#6324) (Kai Cataldo)
...
* ab57e94 Docs: Add example of diff clarity to newline-per-chained-***REMOVED***(#5986) (Vitor Balocco)
...
* 694e1c1 Fix: Add tests to ***REMOVED***default magic number tests (fixes #5385) (Brandon Beeks)
...
* b2aedfe New: Rule to enforce newline after each ***REMOVED***in the chain (fixes #4538) (Rajendra Patil)
...
* 5cd5429 Fix: function expression doc in ***REMOVED***expression (fixes #4964) (Tim Schaub)
...
* Update: `prefer-const` begins to ***REMOVED***separating init (fixes #4474) (Toru Nagashima)
...
* Fix: `indent` multi-line function ***REMOVED***(fixes #4073, fixes #4075) (Gyandeep Singh)
...
* Fix: `indent` should only indent chain calls if the first ***REMOVED***is single line (fixes #3591) (Burak Yigit Kaya)
...
* Docs: Small typo fix in no-useless-***REMOVED***documentation (Paul O’Shannessy)
...
* Fix: Ensure piped in code ***REMOVED***trigger correct errors (fixes #2154) (Nicholas C. Zakas)
...
* Fix: check function ***REMOVED***arguments in comma-spacing (fixes #1515) (Mathias Schreck)
...
* Fix: Useless bind ***REMOVED***in cli-engine (fixes #1181) (Bence Dányi)
...
* Fix: --reset ***REMOVED***now properly ignore default rules in environments.json (fixes #800) (Nicholas C. Zakas)
...
* Add tests to ***REMOVED***100% of eslint.js (Aliaksei Shytkin)
