...
module.exports = {
     ...
     * after the node ***REMOVED***be parsed as a decimal point, rather than a property-access dot.
     * @param {ASTNode} node - The node to check.
     ...
     * @param {Token|string} leftValue The left token. If this is a string, it ***REMOVED***be tokenized and the last token ***REMOVED***be used.
     * @param {Token|string} rightValue The right token. If this is a string, it ***REMOVED***be tokenized and the first token ***REMOVED***be used.
