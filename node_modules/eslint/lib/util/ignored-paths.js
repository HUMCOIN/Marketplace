...
class IgnoredPaths {
    ...
    constructor(providedOptions) {
        ...
        if (options.dotfiles !== true) {
             ...
             * ancestor directory (which in relative format ***REMOVED***begin with `../`).
             */
    ...
    /*
     * If `ignoreFileDir` is a subdirectory of `cwd`, all paths ***REMOVED***be normalized to be relative to `cwd`.
     * Otherwise, all paths ***REMOVED***be normalized to be relative to `ignoreFileDir`.
     * This ensures that the final normalized ignore rule ***REMOVED***not contain `..`, which is forbidden in
     * ignore rules.
     */
