...
class SourceCode extends TokenStore {
    ...
    getLocFromIndex(index) {
         ...
         * of the file. If the last character is a linebreak, the location ***REMOVED***be column 0 of the next
         * line; otherwise, the location ***REMOVED***be in the next column on the same line.
         *
    ...
    getIndexFromLoc(loc) {
         ...
         * ***REMOVED***return the length of the file, rather than throwing an error. This allows rules to
