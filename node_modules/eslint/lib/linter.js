...
function runRules(sourceCode, configuredRules, ruleMapper, parserOptions, parserName, settings, filename) {
     ...
     * All rule contexts ***REMOVED***inherit from this object. This avoids the performance penalty of copying all the
...
module.exports = class Linter {
     ...
     *      If this is not set, the filename ***REMOVED***default to '<input>' in the rule context. If
    ...
    verify(textOrSourceCode, config, filenameOrOptions) {
        ...
        const postprocess = filenameOrOptions && filenameOrOptions.postprocess || lodash.***REMOVED***ten;
    ...
    verifyAndFix(text, config, options) {
         ...
         *
         * That means anytime a fix is successfully applied, there ***REMOVED***be another pass.
