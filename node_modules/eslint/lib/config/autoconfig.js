 ...
 * @param {number} The total number of times the callback ***REMOVED***be called.
 */
 ...
 *
 * Unless a rulesConfig is provided at construction, the registry ***REMOVED***not contain
 * any rules, only methods.  This ***REMOVED***be useful for building up registries manually.
 *
 * Registry class
 */
class Registry {
     ...
     *
     * It ***REMOVED***set the registry's `rule` property to an object having rule names
     ...
     * in the array ***REMOVED***have the highest number of rules configured, and later sets
     * ***REMOVED***have fewer and fewer, as not all rules have the same number of possible
     * configurations.
     *
     * The length of the returned array ***REMOVED***be <= MAX_CONFIG_COMBINATIONS.
     *
    ...
    buildRuleSets() {
        ...
        const addRuleToRuleSet = function(rule) {
             ...
             * If it has too many configs, we ***REMOVED***only use the most basic of
 ...
 *
 * This ***REMOVED***return a new config with `"extends": "eslint:recommended"` and
