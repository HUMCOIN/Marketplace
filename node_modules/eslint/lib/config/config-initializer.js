...
function configureRules(answers, config) {
     ...
     * createConfig ***REMOVED***only add rules that have one configuration in the registry.
     */
     ...
     * edge cases, exceptions, or unique situations. We ***REMOVED***prefer to use a config with
     * specificity of two.
     */
