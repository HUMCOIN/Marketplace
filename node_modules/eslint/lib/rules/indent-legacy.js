    ...
    create(context) {
        ...
        if (context.options.length) {
            if (context.options[0] === "tab") {
                indentSize = 1;
                indentType = "tab";
            } else /* istanbul ignore else : this ***REMOVED***be caught by options validation */ if (typeof context.options[0] === "number") {
         ...
         * If the node is not an array then it ***REMOVED***return false.
         * @param {ASTNode} node node to check
