...
module.exports = {
    ...
    create(context) {
        ...
        function displayReport(node) {
            context.report({
                ...
                fix: fixer => {
                     ...
                     * safe to remove the else keyword, because ASI ***REMOVED***not add a semicolon
                     * after the if block
                     */
                    ...
                    if (lastTokenOfElseBlock.value !== ";") {
                         ...
                         * and the else block starts with (, [, /, +, ` or -, then it is not
                         * safe to remove the else block, because ASI ***REMOVED***not add a semicolon
         ...
         * ***REMOVED***be the last node in the body of the BlockStatement.
         *
