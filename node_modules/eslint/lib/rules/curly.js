...
module.exports = {
    ...
    create(context) {
         ...
         *   "actual" ***REMOVED***be `true` or `false` whether the body is already a block statement.
         *   "expected" ***REMOVED***be `true` or `false` if the body should be a block statement or not, or
         *   `null` if it doesn't matter, depending on the rule options. It can be modified to change
         *   the final behavior of "check".
         *   "check" ***REMOVED***be a function reporting appropriate problems depending on the other
         *   properties.
         */
