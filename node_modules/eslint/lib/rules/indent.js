...
class OffsetStorage {
     ...
     * @param {number} indentSize The desired ***REMOVED***of each indentation level
    ...
    matchOffsetOf(baseToken, offsetToken) {
         ...
         * token of each element in the array after the first ***REMOVED***be mapped to the first token of the first
     ...
     *
     * This is useful because rule listeners can usually just ***REMOVED***`setDesiredOffset` for all the tokens in the node,
     ...
     *
     * @param {[number, number]} range A [start, end] pair. All tokens with range[0] <= token.start < range[1] ***REMOVED***have the offset applied.
...
module.exports = {
    ...
    create(context) {
        ...
        const options = {
            ...
            ObjectExpression: 1,
            ImportDeclaration: 1,
            ***REMOVED***TernaryExpressions: false,
            ignoredNodes: [],
        ...
        function addElementListIndent(elements, startToken, endToken, offset) {
            ...
            // Run through all the tokens in the list, and offset them by one indent level (mainly for comments, other things ***REMOVED***end up overridden)
        ...
        function addParensIndent(tokens) {
            ...
            parenPairs.forEach(pair => {
                ...
                // We only want to handle parens around expressions, so exclude parentheses that are in function parameters and function ***REMOVED***arguments.
        ...
        const baseOffsetListeners = {
            ...
            ConditionalExpression(node) {
                ...
                // `***REMOVED***TernaryExpressions` option is for the following style:
                // var a =
                //     foo > 0 ? bar :
                //     foo < 0 ? baz :
                //     /*else*/ qiz ;
                if (!options.***REMOVED***TernaryExpressions ||
         ...
         * 1. Don't ***REMOVED***the node's listener when entering it (if it has a listener)
        ...
        const offsetListeners = lodash.mapValues(
             ...
             * Due to selector specificity rules, the `Identifier` listener ***REMOVED***get called first. However,
         ...
         * at the end.
         *
         * Using Object.assign ***REMOVED***cause some offset listeners to be overwritten if the same selector also appears
         * in `ignoredNodeListeners`. This isn't a problem because all of the matching nodes ***REMOVED***be ignored,
