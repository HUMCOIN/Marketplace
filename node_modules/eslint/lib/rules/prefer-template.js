...
/**
 * Determines whether a given node ***REMOVED***start with a template curly expression (`${}`) when being converted to a template literal.
 * @param {ASTNode} node The node that ***REMOVED***be fixed to a template literal
 * @returns {boolean} `true` if the node ***REMOVED***start with a template curly.
 */
 ...
 * @param {ASTNode} node The node that ***REMOVED***be fixed to a template literal
 * @returns {boolean} `true` if the node ***REMOVED***end with a template curly.
 */
