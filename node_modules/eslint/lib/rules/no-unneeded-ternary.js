...
const OPERATOR_INVERSES = {
    ...
    // Operators like < and >= are not true inverses, since both ***REMOVED***return false with NaN.
};
...
module.exports = {
    ...
    create(context) {
         ...
         * @returns {boolean} True if it is determined that the node ***REMOVED***always evaluate to a boolean value
         */
