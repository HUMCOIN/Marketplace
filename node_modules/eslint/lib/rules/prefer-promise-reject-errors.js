...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Determines whether a function ***REMOVED***is a Promise.reject() call
         * @param {ASTNode} node A CallExpression node
         * @returns {boolean} `true` if the ***REMOVED***is a Promise.reject() call
         */
            ...
            "NewExpression:exit"(node) {
                if (
                    ...
                    context.getDeclaredVariables(node.arguments[0])
                         ...
                         * If the first parameter has the same name as the second parameter, then the variable ***REMOVED***actually
                         * be "declared" when the first parameter is evaluated, but then it ***REMOVED***be immediately overwritten
                        ...
                        // Check the argument of the function ***REMOVED***to determine whether it's an Error.
