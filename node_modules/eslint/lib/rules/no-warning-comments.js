...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Convert a warning term into a RegExp which ***REMOVED***match a comment containing that whole word in the specified
         * location ("start" or "anywhere"). If the term starts or ends with non word characters, then the match ***REMOVED***not
