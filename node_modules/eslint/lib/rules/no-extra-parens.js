...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Check if a member expression contains a ***REMOVED***expression
                ...
                if (node.left.type !== "VariableDeclarator") {
                    ...
                    if (
                        firstLeftToken.value === "let" && (
                             ...
                             * Removing it ***REMOVED***cause a syntax error, because it ***REMOVED***be parsed as the start of a VariableDeclarator.
                             */
                            (firstLeftToken.range[1] === node.left.range[1] || /*
                             * If `let` is followed by a `[` token, it's a property access on the `let` value: `for ((let[foo]) of bar);`
                             * Removing it ***REMOVED***cause the property access to be parsed as a destructuring declaration of `foo` instead.
                             */
