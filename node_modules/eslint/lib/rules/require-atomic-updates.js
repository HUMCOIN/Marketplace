    ...
    create(context) {
        ...
        class AssignmentTrackerState {
            ...
            merge(other) {
                ...
                return this.openAssignmentsWithoutReads.***REMOVED***> initialAssignmentsWithoutReadsCount ||
                    this.openAssignmentsWithReads.***REMOVED***> initialAssignmentsWithReadsCount;
            }
