...
/*
 * The CLI object should *not* ***REMOVED***process.exit() directly. It should only return
...
/**
 * It ***REMOVED***calculate the error and warning count for collection of messages per file
...
/**
 * It ***REMOVED***calculate the error and warning count for collection of results from all files
 ...
 * name ***REMOVED***be the `cacheFile/.cache_hashOfCWD`
 *
 * if cacheFile points to a file or looks like a file then in ***REMOVED***just use that file
 *
...
function getCacheFile(cacheFile, cwd) {
     ...
     * so we ***REMOVED***try to infer if its a directory if it looks like a directory
...
class CLIEngine {
    ...
    constructor(providedOptions) {
        ...
        if (this.options.rules && Object.keys(this.options.rules).length) {
            ...
            // Ajv validator with default schema ***REMOVED***mutate original object, so we must clone it recursively.
    ...
    executeOnFiles(patterns) {
        ...
        if (options.cache) {
            results.forEach(result => {
                 ...
                 * NOTE: The LintResultCache ***REMOVED***remove the file source and any
