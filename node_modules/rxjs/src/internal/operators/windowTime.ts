 ...
 * ***REMOVED***emit at most fixed number of values. Window ***REMOVED***complete immediately
 * after emitting last value and next one still ***REMOVED***open as specified by
 ...
 *   mergeAll(),                    // ***REMOVED***ten the Observable-of-Observables
 * );
