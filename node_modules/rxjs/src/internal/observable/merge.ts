 ...
 * Observable ***REMOVED***be immediately emitted on the output Observable.
 *
 * ## Examples
 ...
 * // timer ***REMOVED***emit ascending values, one every second(1000ms) to console
 ...
 *
 * // Results in the following:
 * // - First timer1 and timer2 ***REMOVED***run concurrently
 * // - timer1 ***REMOVED***emit a value every 1000ms for 10 iterations
 * // - timer2 ***REMOVED***emit a value every 2000ms for 6 iterations
 * // - after timer1 hits it's max iteration, timer2 will
 * //   continue, and timer3 ***REMOVED***start to run concurrently with timer2
 * // - when timer2 hits it's max iteration it terminates, and
 * //   timer3 ***REMOVED***continue to emit a value every 500ms until it is complete
 * ```
 *
 * @see {@link mergeAll}
 * @see {@link mergeMap}
