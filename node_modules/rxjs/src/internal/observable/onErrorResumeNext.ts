 ...
 * If the source it's subscribed to emits an error or completes, it ***REMOVED***move to the next source
 * without error.
 *
 * If `onErrorResumeNext` is provided no arguments, or a single, empty array, it ***REMOVED***return {@link index/EMPTY}.
 *
 * `onErrorResumeNext` is basically {@link concat}, only it ***REMOVED***continue, even if one of its
