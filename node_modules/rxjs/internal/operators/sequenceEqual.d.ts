 ...
 * up; If any value pair doesn't match, the returned observable ***REMOVED***emit `false` and complete. If one of the
 * observables completes, the operator ***REMOVED***wait for the other observable to complete; If the other
 * observable emits before completing, the returned observable ***REMOVED***emit `false` and complete. If one observable never
 * completes or emits after the other complets, the returned observable ***REMOVED***never complete.
 *
 * ## Example
