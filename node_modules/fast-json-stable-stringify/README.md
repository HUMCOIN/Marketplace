...
Pass `true` in `opts.cycles` to stringify circular property as `__cycle__` - the result ***REMOVED***not be a valid JSON string in this case.

TypeError ***REMOVED***be thrown in case of circular object without this option.
