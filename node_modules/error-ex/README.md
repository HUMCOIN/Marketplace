# node-error-ex [![Travis-CI.org Build Status](https://img.shields.io/travis/Qix-/node-error-ex.svg?style=***REMOVED***-square)](https://travis-ci.org/Qix-/node-error-ex) [![Coveralls.io Coverage Rating](https://img.shields.io/coveralls/Qix-/node-error-ex.svg?style=***REMOVED***-square)](https://coveralls.io/r/Qix-/node-error-ex)
...
- `properties`: if supplied, used as a key/value dictionary of properties to
  ...
  looked up on the error message, and then passed to function values.
    ...
    entry (error-ex ***REMOVED***indent for you). Passed the property value given
    the key.
