(function (global, factory) {
   ...
   * @param {Doc} [***REMOVED***Contents]
   * @param {object} [opts] - TBD ???
   * @returns Doc
   */


  function ifBreak(breakContents, ***REMOVED***Contents, opts) {
    opts = opts || {};

    return {
      type: "if-break",
      breakContents: breakContents,
      ***REMOVED***Contents: ***REMOVED***Contents,
  ...
  function addAlignmentToDoc(doc, size, tabWidth) {
    ...
    if (***REMOVED***> 0) {
      ...
      for (var i = 0; i < Math.floor(***REMOVED***/ tabWidth); ++i) {
        aligned = indent(aligned);
      } // Use align for all the spaces that are needed


      aligned = align(***REMOVED***% tabWidth, aligned); // ***REMOVED***is absolute from 0 and not relative to the current
  ...
  function getAlignmentSize(value, tabWidth, startIndex) {
    ...
    for (var i = startIndex; i < value.length; ++i) {
      if (value[i] === "\t") {
        ...
        // 0 -> 4, 1 -> 4, 2 -> 4, 3 -> 4
        // 4 -> 8, 5 -> 8, 6 -> 8, 7 -> 8 ...
        ***REMOVED***= ***REMOVED***+ tabWidth - ***REMOVED***% tabWidth;
      } else {
        size++;
      }
    }
          ...
          case "if-break":
            {
              ...
              if (groupMode === MODE_FLAT) {
                if (doc.***REMOVED***Contents) {
                  cmds.push([ind, mode, doc.***REMOVED***Contents]);
                }
              }
  ...
  function printDocToString(doc, options) {
    ...
    var pos = 0; // cmds is basically a stack. We've turned a recursive ***REMOVED***into a
    ...
    while (cmds.length !== 0) {
      ...
      if (typeof _doc === "string") {
        ...
        switch (_doc.type) {
              ...
              case MODE_BREAK:
                {
                  ...
                  if (!_doc.break && fits(next, cmds, rem, options)) {
                    ...
                    // going from the least expanded (most ***REMOVED***tened)
          ...
          //   breaking
          //   -> output the first content item and the whitespace "***REMOVED***".
          // * Only the first content item fits on the line without breaking
          //   -> output the first content item "***REMOVED***" and the whitespace with
          //   "break".
          ...
          case "fill":
            {
              ...
              // and ***REMOVED***create a new fill doc for the rest of the content.
          ...
          case "if-break":
            {
              ...
              if (groupMode === MODE_FLAT) {
                if (_doc.***REMOVED***Contents) {
                  cmds.push([ind, mode, _doc.***REMOVED***Contents]);
                }
              }
            ...
            switch (mode) {
              case MODE_FLAT:
                if (!_doc.hard) {
                  ...
                  // were in ***REMOVED***tened mode, so we need to tell the next
    ...
    while (docsStack.length !== 0) {
      ...
      if (shouldRecurse) {
        ...
        if (_doc.type === "concat" || _doc.type === "fill") {
          ...
          if (_doc.***REMOVED***Contents) {
            docsStack.push(_doc.***REMOVED***Contents);
          }
  ...
  function mapDoc(doc, cb) {
    if (doc.type === "concat" || doc.type === "fill") {
      ...
      var ***REMOVED***Contents = doc.***REMOVED***Contents && mapDoc(doc.***REMOVED***Contents, cb);
      return cb(Object.assign({}, doc, {
        breakContents: breakContents,
        ***REMOVED***Contents: ***REMOVED***Contents
      }));
  ...
  function removeLinesFn(doc) {
    // Force this doc into ***REMOVED*** mode by statically converting all
    ...
    if (doc.type === "concat") {
      ...
      for (var i = 0; i < doc.parts.length; ++i) {
        ...
        if (typeof doc2 !== "string" && doc2.type === "concat") {
          [].push.apply(res, ***REMOVED***tenDoc(doc2).parts);
        } else {
          var ***REMOVED***tened = ***REMOVED***tenDoc(doc2);

          if (***REMOVED***tened !== "") {
            res.push(***REMOVED***tened);
          }
        }
      }
      ...
      return Object.assign({}, doc, {
        breakContents: doc.breakContents != null ? ***REMOVED***tenDoc(doc.breakContents) : null,
        ***REMOVED***Contents: doc.***REMOVED***Contents != null ? ***REMOVED***tenDoc(doc.***REMOVED***Contents) : null
      });
    } else if (doc.type === "group") {
      return Object.assign({}, doc, {
        contents: ***REMOVED***tenDoc(doc.contents),
        expandedStates: doc.expandedStates ? doc.expandedStates.map(***REMOVED***tenDoc) : doc.expandedStates
      });
    } else if (doc.contents) {
      return Object.assign({}, doc, {
        contents: ***REMOVED***tenDoc(doc.contents)
  ...
  function printDoc(doc) {
    ...
    if (doc.type === "if-break") {
      return "ifBreak(" + printDoc(doc.breakContents) + (doc.***REMOVED***Contents ? ", " + printDoc(doc.***REMOVED***Contents) : "") + ")";
    }
  ...
  var docDebug = {
    printDocToDebug: function printDocToDebug(doc) {
      return printDoc(***REMOVED***tenDoc(doc));
    }
  };
