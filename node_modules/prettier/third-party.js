...
function _classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot ***REMOVED***a class as a function");
  }
}
...
function _possibleConstructorReturn(self, call) {
  if (***REMOVED***&& (typeof ***REMOVED***=== "object" || typeof ***REMOVED***=== "function")) {
    return call;
  }
...
} // Note: a long line without a suitable break point ***REMOVED***exceed the width limit.
...
function foldLine(line, width) {
  ...
  var breakRe = / [^ ]/g; // note: the match index ***REMOVED***always be <= length-2.
